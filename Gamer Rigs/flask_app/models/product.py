...
class Product:
    ...
    @classmethod
    def get_all_by_category(cls, form_data):
        query = "SELECT * FROM products WHERE category_id = %(category_id)s;"
    ...
    @classmethod
    def get_all_users_by_product(cls, form_data):
        # get all users who saved a product
